...
class _AdminDashboardScreenState extends ConsumerState<AdminDashboardScreen> {
  ...
  Future<void> _checkAccess() async {
    ...
    try {
      ...
      final allowed = ['admin', 'super_admin', 'moderator', 'exco'];
  ...
  Future<void> _assignExco() async {
    ...
    try {
      ...
      if (_selectedRole == ExcoRole.blogEditor) {
        await SupabaseService.client.from('admin_permissions').upsert({'admin_id': userId, 'permission': AdminPermission.manageBlog, 'granted_by': SupabaseService.currentUserId});
      }
