    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        if (mediaUrls.isNotEmpty)
          ClipRRect(child: CachedNetworkImage(imageUrl: mediaUrls.first as String, width: double.infinity, height: 280, fit: BoxFit.cover,
            placeholder: (_, __) => Container(height: 280, color: GacomColors.cardDark),
            errorWidget: (_, __, ___) => Container(height: 180, color: GacomColors.cardDark, child: const Icon(Icons.broken_image_outlined, color: GacomColors.textMuted)))),
