...
class SupabaseService {
  ...
  static Future<AuthResponse> signUp({
    ...
    // NOTE: We do NOT manually insert into profiles here.
    // The Supabase trigger `on_auth_user_created` handles profile creation
    // automatically using the metadata below. A double-insert caused the
