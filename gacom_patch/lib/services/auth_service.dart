...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  Future<bool> signIn(String email, String password) async {
    ...
    try {
      ...
      if (response.user != null) {
        // Small delay to allow the DB trigger to finish creating the profile
  ...
  Future<bool> signUp(String email, String password, String username, {String? displayName, String? gamerTag}) async {
    state = state.copyWith(isLoading: true, error: null);
    try {
