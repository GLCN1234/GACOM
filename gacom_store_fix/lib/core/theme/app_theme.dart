...
class GacomTheme {
  ...
  static ThemeData get lightTheme {
    return ThemeData(
      ...
      textTheme: GoogleFonts.rajdhaniTextTheme(const TextTheme(
        displayLarge: TextStyle(fontSize: 56, fontWeight: FontWeight.w800, color: Color(0xFF111111), letterSpacing: -1),
        headlineLarge: TextStyle(fontSize: 32, fontWeight: FontWeight.w700, color: Color(0xFF111111)),
        headlineMedium: TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: Color(0xFF111111)),
        titleLarge: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: Color(0xFF111111)),
        ...
        bodyMedium: TextStyle(fontSize: 13, color: Color(0xFF444444)),
        bodySmall: TextStyle(fontSize: 11, color: Color(0xFF888888)),
        labelLarge: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xFF111111), letterSpacing: 1.2),
      )),
      appBarTheme: AppBarTheme(
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(20),
          side: const BorderSide(color: Color(0xFFE0E0E0), width: 0.7),
        ),
      ),
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        enabledBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: Color(0xFFDDDDDD), width: 0.7),
        ),
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(16),
          borderSide: const BorderSide(color: GacomColors.deepOrange, width: 1.5),
      ...
      dividerTheme: const DividerThemeData(color: Color(0xFFE0E0E0), thickness: 0.7),
